...
\begin{enumerate}[noitemsep]
    \item PDFTriage \cite{saad2023pdftriage}: menunjukkan pentingnya segmentasi
    layout-aware untuk QA PDF; relevan untuk SOP/pedoman multi-bab.
    \item SEACrowd \cite{lovenia2024seacrowd}: menyoroti ketersediaan data dan
    pentingnya evaluasi bahasa Indonesia dalam lanskap Asia Tenggara.
    \item IndoNLU/IndoBERT(-Lite) \cite{wilie2020indonlu,wilie2020indobert}:
    menyediakan model dasar efisien untuk \textit{fine-tuning} QA Indonesia.
    \item DPR \cite{karpukhin2020dpr}: \textit{dense retriever} untuk memilih
    paragraf; cocok digabung dengan reader IndoBERT-Lite.
    \item SLP \cite{jurafsky2025slp}: kerangka teori NLP/IR untuk merapikan
...
\begin{longtable}{|p{0.04\textwidth}|p{0.26\textwidth}|p{0.26\textwidth}|p{0.14\textwidth}|p{0.2\textwidth}|}
    ...
    \hline
    \endhead
    1 & DFTriage: Question Answering over Long, Structured Documents \cite{saad2023pdftriage} & QA dokumen PDF panjang/berstruktur & Segmentasi layout + QA & Akurasi meningkat saat struktur halaman dipertahankan \\
    \hline
    2 & “SEACrowd: A Multilingual Multimodal Data Hub and Benchmark Suite for Southeast Asian Languages \cite{lovenia2024seacrowd} & Kesenjangan data/benchmark SEA & Kumpulan korpus \& tugas multimodal & Legitimasi evaluasi bahasa Indonesia \\
    \hline
    3 & IndoBERT: A Pretrained Language Model for Indonesian \cite{wilie2020indobert} dan IndoNLU: Benchmark and Resources for Evaluating Indonesian Natural Language Understanding \cite{wilie2020indonlu} & Kurangnya backbone bahasa Indonesia & Pretrained LM + benchmark & Backbone efisien untuk QA Indonesia \\
    \hline
    4 & Dense Passage Retrieval for Open-Domain Question Answering \cite{karpukhin2020dpr} & Pemilihan paragraf relevan QA & \textit{Dense passage retrieval} & Baseline retriever untuk pipeline PDF \\
    \hline
    5 & Speech and Language Processing \cite{jurafsky2025slp} & Kerangka teori NLP/IR & Buku teks & Definisi formal, metrik EM/F1 \\
    \hline
\end{longtable}
